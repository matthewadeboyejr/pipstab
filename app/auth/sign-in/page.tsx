        ...
        <div className="w-full flex flex-col md:flex-row gap-3 item-center justify-center pt-5 px-2 md:px-5 pb-4">
          <Card className="bg-background py-[32px] lg:py-[64px] px-0 lg:px-[32px] w-full max-w-[471px] border-0">
            <CardContent className="h-full flex flex-col items-start justify-center">
              ...
              >
                ...
                <div className="flex justify-end -mt-1">
                  <Link 
                    ...
                    className="text-xs font-medium text-accent hover:underline decoration-accent/30 transition-all font-['Montserrat']"
                  >
                    Forgot Password?
                  </Link>
                </div>
              ...
              <p className="auth-question text-center w-full mt-6 font-['Montserrat']">
                Interested in joining the beta?{" "}
                <Link href="/early-access" className="text-accent font-black">
                  Get Early Access
                </Link>
              </p>

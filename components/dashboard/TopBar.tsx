        ...
        >
            ...
            <div className="flex items-center gap-3">
                <button
                    ...
                    className="lg:hidden p-2 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/60 dark:hover:bg-white/5 transition-colors"
                >
            ...
            <div className="flex items-center gap-2">
                ...
                {/* Search */}
                <div className="hidden md:flex items-center gap-2 px-3 py-2 rounded-xl bg-muted/60 dark:bg-white/5 border border-border/50 w-64 ml-2">

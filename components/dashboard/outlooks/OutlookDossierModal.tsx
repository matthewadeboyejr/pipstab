...
Generated via PipTab Analytics Platform`;
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 md:p-6 bg-black/90 backdrop-blur-lg animate-in fade-in duration-200">
            {/* Embedded Print Styles to guarantee clean multi-page PDF output without image cutting */}
            <style jsx global>{`
                @media print {
                    @page {
                        size: A4 portrait;
                    ...
                    body {
                        background: ${isLightMode ? "#FFFFFF" : "#070A11"} !important;
                        color: ${isLightMode ? "#0F172A" : "#E2E8F0"} !important;
            ...
            >
                ...
                >
                    {/* Capture target container with id="dossier-print-root" for perfect print targeting */}
                    <div
                        id="dossier-print-root"
                        ref={dossierRef}
                        className="p-6 sm:p-10 space-y-8 w-full max-w-[1200px] mx-auto"
                    >
                        {/* ================= PAGE 1: MACRO THESIS & CONTEXT ================= */}
                        <div className="space-y-6">
                            {/* 1. Executive Top Dossier Banner */}
                            <div
                                className={`p-6 rounded-2xl border print-avoid-break transition-all ${
                                    isLightMode
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div
                                    className={`p-6 rounded-2xl border flex flex-col justify-between space-y-4 print-avoid-break ${
                                        isLightMode
                                            ? "bg-white border-slate-200 shadow-sm"
                        ...
                        <div className="hidden print:block pdf-page-break" />

                        {/* ================= PAGE 2: EXECUTION & POINT OF INTEREST ================= */}
                        <div className="space-y-6">
                            {/* Page 2 Header for Print */}
                            <div className="hidden print:flex items-center justify-between pb-3 border-b border-border/40 font-mono text-xs text-muted-foreground">
                                <span>{outlook.title} • {outlook.pair} ({outlook.direction})</span>
                        ...
                        {/* Page break marker for Print before AI audit if present */}
                        {aiAudit && includeAiInExport && (
                            <div className="hidden print:block pdf-page-break" />
                        )}

                        {/* ================= PAGE 3 / BOTTOM: AI STRATEGY AUDIT & FOOTER ================= */}
                        <div className="space-y-6">
                            ...
                            {aiAudit && includeAiInExport && (
                                <motion.div
                                    ...
                                    className={`p-6 rounded-2xl border print-avoid-break shadow-lg ${
                                        isLightMode
                            ...
                            <div
                                className={`p-5 rounded-2xl border print-avoid-break flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono ${
                                    isLightMode
